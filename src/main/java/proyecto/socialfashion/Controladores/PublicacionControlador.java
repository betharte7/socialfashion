...
public class PublicacionControlador {
    ...
    public String publicacionesParaRegistados(HttpSession session, ModelMap modelo) {
        ...
        ArrayList<Publicacion> publicacionesAlta = (ArrayList<Publicacion>) publicacionServicio
                .listaPublicacionOrdenadasPorFechaAlta();
        modelo.addAttribute("publicacionesAlta", publicacionesAlta);
        // HTML con la pagina en donde se encuentran las publicaciones
        return "index.html";
        /*
    ...
    public String registro(@RequestParam String titulo, @RequestParam String contenido,
            @RequestParam("categoria") String categoria, ModelMap modelo, MultipartFile archivo, HttpSession session) {
